...
| 最大玩家数 | 100 | Maximum number of players that will be allowed to connect to server. Maximum is 100. Default: 100, |
| World Mode | 0 | Whether to use normal (0) or hard (1) mode for world. Default: 0. |
| 自动更新 | 1 | Enable automatic updates on boot: Default: true |

## Game Ports

| 端口 | 默认值 | 协议 | Description |
|---------|---------|----------|---------------------------------------------|
| Server | 27015 | UDP | |
| 查询 | 27016 | UDP | Automaticaly bind by the game server (Game port + 1) |
